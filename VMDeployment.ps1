...
Connect-AzAccount -SubscriptionName urbana-vcl-citrix -Identity 
...
New-AzResourceGroupDeployment `
    ...
    -TemplateParameterUri "https://github.com/jdcox83/StaffVMtemplate/blob/main/StaffVM-template.json"